define(["require", "exports", "./VariablesView"], function (require, exports, VariablesView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.authoringHelp = `
...
The key ideas and their icons in the interface are: command (${VariablesView_1.Glyph.command}), reply (${VariablesView_1.Glyph.reply}), move (${VariablesView_1.Glyph.move}),
requirements (${VariablesView_1.Glyph.requirements}), variables (${VariablesView_1.Glyph.present}), changes (${VariablesView_1.Glyph.changes}), context (${VariablesView_1.Glyph.context}), focus, and rules.

A StoryHarp adventure consists of commands (${VariablesView_1.Glyph.command}) chosen by the user which produce replies (${VariablesView_1.Glyph.reply}) announced by the system.
...
Commands may have requirements (${VariablesView_1.Glyph.requirements}) which must be met before they are available.

Requirements are specified in terms of global variables that may be true (${VariablesView_1.Glyph.present}) or false (${VariablesView_1.Glyph.absent}).
...
Commands may make changes (${VariablesView_1.Glyph.changes}) to the state of variables, which in turn may affect the availability of commands.
Changes are specified as a list of variables, and whether each variable will be set to true or false.

Most commands only make sense in a certain context (${VariablesView_1.Glyph.context}), which is usually defined by a physical location.
...
So, the most common change is to move (${VariablesView_1.Glyph.move}) the focus from one context to another.
