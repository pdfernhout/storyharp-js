    ...
    view() {
        ...
        return m(".RuleMapView.h-100.w-100.flex.flex-column",
            m("div.flex-none.mb1", 
                ...
                m("div.dib.ml3",
                    m("button.mt1", { title: "Center the map", onclick: () => centerMap() }, "center"),
                    m("button.ml1.mt1", { title: "Change scale and scrolling to default value", onclick: () => resetMap() }, "reset"),
                ),
            ),
            m("div.flex-auto.ba",
            ...
            m("div.flex-none.mb1", 
                m("button.mt1", { title: "Make a new context", onclick: () => this.PopupNewContextClick() }, "+context"),
                m("button.ml1.mt1", { title: "Make a new command", onclick: () => this.PopupNewCommandClick() }, "+command"),
                m("button.ml1.mt1", { title: "Make a new link", onclick: () => this.PopupNewLinkClick() }, "+link"),
                m("label.dib.ml2", 
